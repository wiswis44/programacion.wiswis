    ...
    public static void main(String[] args) {
        ...
        while (opcio != 8) {
            ...
            if (opcio == 8) {
                ...
                //elegir un numero 0 o 1 
                int tipusConstructor = rand.nextInt(2);

                Figura f; // para resolver la problema de controlar los identefecadores 

                if (opcio == 1) {
                    if (tipusConstructor == 0) {
                        f = new Triangle(); // pedir datos por teclado 
                    } else {
                        f = new Triangle(5, 10); // ya tiene los parametros de entrada . 
                    }
                } else if (opcio == 2) {
                    if (tipusConstructor == 0) {
                        f = new Quadrat();
